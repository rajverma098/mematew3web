            ...
            articles.map((item, index) => (
              <div className="col-lg-4 col-md-6" key={item.id}>
                <div className={`item ${index !== data.length - 1 ? 'mb-50' : ''}`}>
                  <div className="img">
                    <img src="https://res.cloudinary.com/dn0jqjad3/image/upload/v1744183570/samples/animals/three-dogs.jpg" alt="" />
                    <div className="date">
                      <Link href={`/blog/${item.slug}`}>{item.date}</Link>
                    </div>
                  </div>
                  <div className="cont mt-30">
                    ...
                    <Link href={`/blog/${item.slug}`} className="mt-20 ls1 sub-title">Read More <i className="ml-5">
