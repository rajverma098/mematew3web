              ...
              <div className="tab-content current" id="tabs-1">
                <div className="item">
                  ...
                  <div className="cont sub-bg">
                    ...
                    <div className="text">
                      <h3>UI/UX Design</h3>
                      <p>W3 Web creates intuitive, responsive, user-focused UI/UX designs that enhance engagement, strengthen brands, improve usability, and drive measurable business growth.</p>
                    </div>
              ...
              <div className="tab-content" id="tabs-2">
                <div className="item">
                  ...
                  <div className="cont sub-bg">
                    ...
                    <div className="text">
                      <h3>Branding</h3>
                      <p>W3 Web builds branding-focused websites with strategic design, seamless functionality, and performance optimisation to strengthen brands, build trust, and drive growth.</p>
                    </div>
              ...
              <div className="tab-content" id="tabs-3">
                <div className="item">
                  ...
                  <div className="cont sub-bg">
                    ...
                    <div className="text">
                      <h3>Development</h3>
                      <p>W3 Web creates branding-focused websites that strengthen identity, build trust, engage audiences, enhance performance, and help businesses stand out online.</p>
                    </div>
                    <Link href="/dark/page-services" className="mt-30">
                      <span className="mr-15">Read More</span>
                      <i className="fas fa-long-arrow-alt-right"></i>
              ...
              <div className="tab-content" id="tabs-4">
                <div className="item">
                  ...
                  <div className="cont sub-bg">
                    ...
                    <div className="text">
                      <h3>Marketing</h3>
                      <p>W3 Web delivers data-driven digital marketing solutions that boost visibility, generate qualified leads, increase conversions, and drive measurable business growth.</p>
                    </div>
                    <Link href="/dark/page-services" className="mt-30">
                      <span className="mr-15">Read More</span>
                      <i className="fas fa-long-arrow-alt-right"></i>
          ...
          <div className="col-lg-5 offset-lg-1 valign order1">
            <div className="serv-tab-link tab-links full-width md-mb50">
              <div className="sec-lg-head mb-80">
                ...
                <p>We focus on innovation, performance, and user experience to help businesses grow, improve visibility, and achieve long-term success in today’s competitive digital landscape. </p>
              </div>
              <ul className="rest">
